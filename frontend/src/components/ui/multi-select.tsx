...
const multiSelectVariants = cva('m-1 transition-all duration-300 ease-in-out', {
  variants: {
    ...
    badgeAnimation: {
      bounce: 'hover:-translate-y-1 hover:scale-100 hover:-translate-y-0',
...
interface MultiSelectProps
   ...
   * Optional, defaults to "Выберите опции".
   */
  placeholder?: string
...
export const MultiSelect = React.forwardRef<MultiSelectRef, MultiSelectProps>(
  (
    ...
    const getBadgeAnimationClass = () => {
      if (animationConfig?.badgeAnimation) {
        switch (animationConfig.badgeAnimation) {
          case 'bounce':
            return isAnimating ? 'animate-bounce' : 'hover:-translate-y-1 hover:scale-102'
          case 'pulse':
    ...
    const getWidthConstraints = () => {
      const defaultMinWidth = screenSize === 'mobile' ? '0px' : '192px'
      ...
      <>
        ...
        <Popover modal={modalPopover} onOpenChange={setIsPopoverOpen} open={isPopoverOpen}>
          ...
          <PopoverTrigger asChild>
            ...
            >
              {selectedValues.length > 0 ? (
                <div className="flex justify-between items-center w-full mx-[-10px] my-[-6px]">
                  <div
                    className={cn(
                      'flex items-center',
                        ...
                        return (
                          <Badge
                            className={cn(
                              ...
                              '[&>svg]:pointer-events-auto px-1.5 py-1 font-normal m-0.5',
                            )}
                            key={value}
                            style={{
                              ...badgeStyle,
                          ...
                          >
                            ...
                            <div
                              ...
                              className="h-4 w-4 cursor-pointer hover:bg-white/20 rounded-sm focus:outline-none focus:ring-1 ml-1 focus:ring-white/50"
                              onClick={(event) => {
                  ...
                  <div className="flex items-center justify-between">
                    <div
                      ...
                      className="flex items-center justify-center h-4 w-4 mx-2 cursor-pointer text-muted-foreground hover:text-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-1 rounded-[4px]"
                      onClick={(event) => {
                        event.stopPropagation()
                        handleClear()
                      }}
                    ...
                    <ChevronDown aria-hidden="true" className="h-4 mx-2 cursor-pointer text-[var(--gray-12)]" />
                  </div>
                </div>
              ) : (
                <div className="flex items-center justify-between w-full mx-auto">
                  <span className="text-sm text-[var(--gray-12)] leading-[18px]">{placeholder}</span>
                  <ChevronDown className="h-4 cursor-pointer text-[var(--gray-12)]" />
                </div>
              )}
            </Button>
          </PopoverTrigger>
                  ...
                  <CommandGroup>
                    ...
                    >
                      <div
                        aria-hidden="true"
                        className={cn(
                          'flex h-4 w-4 items-center justify-center rounded-[4px] border border-primary',
                      ...
                      {group.options.map((option) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            {option.icon && (
                              <option.icon aria-hidden="true" className="mr-2 h-4 w-4 text-muted-foreground" />
                            )}
